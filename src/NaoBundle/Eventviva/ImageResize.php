<?php
namespace NaoBundle\Eventviva;
use \Exception;
/**
 * PHP class Redimensionner & agrandir les images
 */
class ImageResize
{
    const CROPTOP = 1;
    ...
    /**
     * Charge la source de l'image et ses propriétés de l'objet instancié
     *
    ...
    public function __construct($filename)
    {
        ...
        switch ($this->source_type) {
            ...
            case IMAGETYPE_JPEG:
                ...
                // set Nouvelle largeur et hauteur pour l'image (modification)
            ...
            case IMAGETYPE_PNG:
                ...
                break;
            default:
                throw new \Exception('Type d\'image non prise en charge');
                break;
        }//return $this;
    ...
    /**
    * Convertir l'image en chaîne avec les paramètres actuels
    *
    * @return string
    */
    ...
    /**
     * Exporter l'image vers le navigateur
     * @param string $image_type
     * @param integer $quality
     */
    ...
    /**
     * Redimensionner l'image en fonction de la hauteur donnée (largeur proportionnelle)
     *
    ...
    /**
     * Redimensionner l'image en fonction de la largeur donnée (hauteur proportionnelle)
     *
     * @param integer $width
     * @param boolean $allow_enlarge
     * @return \static
    ...
    /**
     * Redimensionner l'image pour mieux s'adapter aux dimensions données
     *
    ...
    /**
     * Redimensionner l'image selon l'échelle donnée (proportionnellement)
     *
    ...
    /**
     * Redimensionner l'image en fonction de la largeur et de la hauteur données
     *
     * @param integer $width
     * @param integer $height
     * @param boolean $allow_enlarge
    ...
    /**
     * Image en fonction de la largeur, de la hauteur et de la position
     *
     * @param integer $width
     * @param integer $height
     * @param boolean $allow_enlarge
